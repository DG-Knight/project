  ...
  <div class="card">
    <div class="card-body">
      <div class="page-header">
        <h3 class="text-center text-primary">--การอบรม--</h3>
      </div>
<a href="dashboard.php?file=user/training_form" class="btn btn-success"><i class="fa fa-plus"></i> เพิ่มการอบรม </a>
  <div class="table-responsive">
                  <table class="table table-striped">
                    <thead>
                      ...
                      <th scope="col"><b>จำนวนวันที่อบรม</b></th>
                      <th scope="col"><b>สถานที่อบรม</b></th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?=$data->training_total;?></td>
                          <td><?=$data->training_location;?></td>
                          ...
                          <td>
                            ...
                            <a href="dashboard.php?file=user/training_del&id=<?=$data->training_id?>"onclick="return confirm('ยืนยันว่าลบ')"class="btn btn-danger">
