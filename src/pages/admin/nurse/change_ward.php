  ...
  <div class="card">
    <div class="card-body">
      <div class="page-header">
        <h3 class="text-center text-primary">--การเปลี่ยนเวร--</h3>
      </div>
      <a href="dashboard.php?file=admin/nurse/change_ward_form" class="btn btn-success"><i class="fa fa-plus"></i> เพิ่มการเปลี่ยนเวร </a>
