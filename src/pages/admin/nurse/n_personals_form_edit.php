...
?>
<form action="dashboard.php?file=admin/nurse/n_personals_edit" method="post"style="padding-left:100px;padding-right:100px">
  <div class="form-row">
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <select id="user_position" name="user_position" class="form-control" disabled="disabled">
        <?php
    ...
    <div class="form-group col-md-4">
      ...
      <select id="user_level"  name="user_level"class="form-control" disabled="disabled">
